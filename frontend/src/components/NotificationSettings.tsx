...
function NotificationSettings() {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                You'll receive alerts for new job openings
              </p>
            </div>
          </div>
          <button
  ...
  if (showForm) {
    return (
      <div className="card">
        <h3 className="font-semibold text-gray-900 mb-4">Set Up Job Alerts</h3>
    ...
    <div className="card">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-medium text-gray-900">Get Job Alerts</h3>
            <p className="text-sm text-gray-500">
              Never miss a new job opening
            </p>
          </div>
        </div>
        <button
